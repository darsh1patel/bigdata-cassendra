# -*- coding: utf-8 -*-
"""BigDataAssigment.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1m60xunrWsHow5qrBT0gTlRDhFu75bkxh
"""
...
cloud_config= {
  'secure_connect_bundle': '/content/secure-connect-salesdb.zip'
}

with open("/content/salesDB-token.json") as f:
    secrets = json.load(f)
...
df.rename(columns={
    ...
    'TotalRevenue': 'amount',
    'Country': 'region'  # ✅ Corrected: Rename 'Country' to 'region'
}, inplace=True)
...
cloud_config = {'secure_connect_bundle': '/content/secure-connect-salesdb.zip'}
with open("/content/salesDB-token.json") as f:
    secrets = json.load(f)
...
#Gold Table 3: Total Sales by Region
